...
namespace BaoMen.Framework.System.DataAccess
{
    ...
    public partial class Province : DapperDataAccess<string,Entity.Province, Entity.ProvinceFilter>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public Province(string connectionString, string providerName) : base(connectionString, providerName)
        {
        ...
        /// 数据库表名
        /// </summary>
        protected override string TableName { get { return "sys_province"; } }
        ...
        /// <returns></returns> 
        protected override DapperCommand CreateInsertCommand(Entity.Province item)
        {
        ...
        /// <param name="item">实体数据</param>
        /// <returns></returns>
        protected override DapperCommand CreateUpdateCommand(Entity.Province item)
        {
        ...
        /// <returns></returns>
        protected override DapperCommand CreateDeleteCommand(Entity.Province item)
        {
        ...
        protected override (string, DynamicParameters) CreateFilterSqlWhere(Entity.ProvinceFilter filter)
        {
